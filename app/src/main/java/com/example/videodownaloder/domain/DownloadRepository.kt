...
import com.example.videodownaloder.data.download.DownloadProgress
import com.example.videodownaloder.data.download.VideoDownloadResult
...
import com.example.videodownaloder.data.download.VideoVerificationResult
...
import com.example.videodownaloder.data.extract.PageFetchResult
import com.example.videodownaloder.data.extract.PageFetcher
import com.example.videodownaloder.data.media.MediaSaveResult
import com.example.videodownaloder.data.media.MediaSaver
import com.example.videodownaloder.data.media.SaveVideoRequest
import com.example.videodownaloder.data.media.WriteResult
import com.example.videodownaloder.util.FileNameSanitizer
